...
_Welcome to "That's my (User) Story and I'm sticking to it!" Tech tales for the curious and short of attention span._

You've probably heard this one before: the one where the engineer spots an inefficiency in production, fixes it, and saves the company millions.  

What's that engineer's title?  

Senior Application Engineer?  
Chief Technology Officer?  
Master Enterprise Cloud Architect Extraordinaire?  

How about _factory line worker?_

Let me tell you a quick story about Brandon Schenz.  
...
The challenge was that the work orders were *NOT* in the same sort-order as the glass. So the factory workers spent _a lot_ of time working out all of that math each day on-the-fly.  
...
Using nothing but a piece of gum, a paper clip, and a free VB3 development environment he got from his college's student bookstore, Brandon wrote a program to do exactly that.
...
When I heard his story, I had to ask him what drove him to go above and beyond like that. Because, in hindsight, it might sound *obvious* to write a program to  calculate the glass's size and to optimally sort work orders for the factory line. But put yourself in a factory worker's shoes: your job doesn't even involve _using_ a computer, much less _programming_ one. Plus, why rock the boat? Why take on additional responsibility? Why risk failure?
